...
class Database{
	...
	private $db_user = "userdev";  // Change as required
	private $db_pass = "password";  // Change as required
	private $db_name = "db_notarisfemira";	// Change as required
	...
	public function select($table, $rows = '*', $join = null, $where = null, $order = null, $limit = null){
		...
		// echo "<p><small><code>$q</code></small></p>"; // Debugging purpose
        ...
        if($this->tableExists($table)){
			...
			if($query){
				...
				array_push($this->result, mysql_error() . ' : ' . $q );
				return false; // No rows where returned
			}
      	}else{
    ...
    public function update($table,$params=array(),$where){
    	...
    	if($this->tableExists($table)){
            ...
            if($query = @mysql_query($sql)){
            	...
            	array_push($this->result,mysql_error() . ' - ' . $sql);
