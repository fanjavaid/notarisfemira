...
<?php
	...
	$condition_type = "tb_karyawan.kode";
	...
	$db->select('tb_profil','tb_profil.uid as profId, tb_profil.fullname, tb_profil.gender, tb_profil.address, tb_profil.phone1, tb_karyawan.uid as karUid, tb_karyawan.kode','tb_karyawan ON tb_karyawan.profil_id = tb_profil.uid', $condition, null); // Table name, Column Names, JOIN, WHERE conditions, ORDER BY conditions
	$res = $db->getResult();
?>
	...
	<div class="row">
	  	<div class="col-lg-6">
			<div class="input-group">
		      ...
		      <input type="hidden" name="module" value="karyawan" />
...
<table class="table table-striped table-hover">
	...
	<tr>
		...
		<td class="menu-table">
			...
			<a href="main.php?module=karyawan&menu=update&uid=<?php echo $data['karUid'] ?>" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
			<a href="#" class="link-modal" id="delete" data-id="<?php echo $data['profId'] ?>" data-second-id="<?php echo $data['karUid'] ?>" title="Delete"><span class="glyphicon glyphicon-remove red"></span></a>
		</td>
	</tr>
...
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
  	<form method="post" action="main.php?module=karyawan&process=delete">
