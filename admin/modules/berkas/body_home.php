...
<?php
	...
	$condition_type = "tb_berkas.kode";

	if(isset($_GET['condition_type'])) {
		if ($_GET['condition_type'] == "nama") {
			$condition_type = "tb_berkas.nama_berkas";
		}
	}
	...
	$db->select('tb_berkas','tb_berkas.*',null, $condition, null); // Table name, Column Names, JOIN, WHERE conditions, ORDER BY conditions
	$res = $db->getResult();
	...
	<div class="row">
	  	<div class="col-lg-6">
			<div class="input-group">
		      ...
		      <input type="hidden" name="module" value="berkas" />
...
<table class="table table-striped table-hover">
	...
	<tr>
		...
		<td class="menu-table">
			<a href="main.php?module=berkas&menu=update&uid=<?php echo $data['uid'] ?>" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
...
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
  	<form method="post" action="main.php?module=berkas&process=delete">
